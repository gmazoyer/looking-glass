...
final class LookingGlass {
  ...
  public function render() {
    ...
    print('<link href="libs/bootstrap-3.3.5/css/bootstrap.min.css" rel="stylesheet" />');
    if ($this->frontpage['bootstrap_theme']) {
      print('<link href="libs/bootstrap-3.3.5/css/bootstrap-theme.min.css" rel="stylesheet" />');
    }
    ...
    print('<script src="libs/bootstrap-3.3.5/js/bootstrap.min.js"></script>');
